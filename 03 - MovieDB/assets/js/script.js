...
async function getMovies() {
    const response = await fetch("https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1&page=1"); // changed just to host on githubpages, but originaly is localhost:3000/api
